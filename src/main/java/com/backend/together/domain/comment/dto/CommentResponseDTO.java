...
public class CommentResponseDTO{
    ...
    public CommentResponseDTO(Long id, String content, CommentMemberDTO writer) {
        this.id = id;
    ...
    public static CommentResponseDTO convertCommentToDTO(Comment comment) {
        return comment.getIsDeleted() ?
                ...
                new CommentResponseDTO(comment.getId(), comment.getContent(), new CommentMemberDTO(comment.getWriter())); // comment.getWriter()
    }
}
