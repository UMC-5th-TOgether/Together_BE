...
public enum ErrorStatus implements BaseErrorCode {
    ...
    SELF_MATCHING_DECLINE(HttpStatus.BAD_REQUEST, "MATCHING4003", "자기자신과 매칭하는 것은 불가능합니다."),
    // 리뷰 관련 에러
    REVIEW_NOT_FOUND(HttpStatus.BAD_REQUEST, "REVIEW4001", "해당 리뷰가 존재하지 않습니다"),
    SELF_REVIEW_DECLINE(HttpStatus.BAD_REQUEST, "REVIEW4002", "자기 자신에게 후기를 남기는 것은 불가능합니다."),
    // 차단 관련 에러
